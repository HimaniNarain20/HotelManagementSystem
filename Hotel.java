...
public class Hotel extends JFrame implements ActionListener
{
	...
	public Hotel()
	{
		...
		l47=new JLabel("This software is developed by Himani Narain,Tejaswi Kundur And Shivangi Katiyar   ");
		l46.setFont(mfnt);
		l47.setFont(mfnt);
		 ...
		 try
			{
				...
				con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/htl","root","root");
...
public void actionPerformed(ActionEvent ee)
	{
		...
		if(ee.getSource()==b13)
			...
			try
			{
				...
				ps.setInt(13,Integer.parseInt(t37.getText()));
		...
		if(ee.getSource()==b15)
			...
			try
			{
				ps=con.prepareStatement("Select  * from customer order by CCode desc");	
				rs=ps.executeQuery();
				rs.next();
				str=rs.getString(1);
		...
		if(ee.getSource()==b16)
		{
			...
			try
			{
				ps=con.prepareStatement("Select  * from booking order by BNo desc");	
				rs=ps.executeQuery();
				rs.next();
				str=rs.getString(1);
				num=Integer.parseInt(str.substring(1));
		...
		if(ee.getSource()==b17)
			...
			try
			{
				ps=con.prepareStatement("Select * from billing order by BillNo desc");	
				rs=ps.executeQuery();
				rs.next();
				str=rs.getString(1);
		...
		public void focusLost(FocusEvent e)
		{
			...
			{		
				...
				t39.setText(rs.getString(4));
                                t26.setText(rs.getString(7));
		
                              String datestr1=rs.getString(4);
                             String datestr2=rs.getString(7);
	       ...
	       int nod = (int)(difference / (1000*60*60*24));
               
	     
                     
                                t27.setText(String.valueOf(nod));
				ps=con.prepareStatement("Select * from rooms where RNo=?");	
				ps.setInt(1,Integer.parseInt(t38.getText()));
				rs=ps.executeQuery();
			        rs.next();
				...
				st=amt*Integer.parseInt(t30.getText())/100;	
			...
			if(e.getSource()==t37)
			{
				t35.setText(String.valueOf(t34.getText()));
                        ...
                        String nba=t34.getText();
                        String ddate=t26.getText();
			if(e.getSource()==t50)
			{
				...
				{		
					...
					rs=ps.executeQuery();
                                        ...
                                        rs=ps.executeQuery();
                                        rs.next();
                                        t58.setText(rs.getString(7));
                                        String bno=rs.getString(1);
                                        ps=con.prepareStatement("Select * from billing where BNo=?");
                                        ps.setString(1,bno);
                                        rs=ps.executeQuery();
                                        rs.next();
                                        t60.setText(rs.getString(10));
                                        elst.setListData(ss);
				elst.setVisibleRowCount(5);*/
